...
export function authorizeUrlFor(provider: Exclude<ConnectorProvider, "profound" | "webflow" | "website">, input: OAuthStartInput, env: NodeJS.ProcessEnv, now: Date = new Date()): string {
